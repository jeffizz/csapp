...
0000000000001129 <main>:
    ...
    1131:	48 8b 45 f0          	mov    -0x10(%rbp),%rax //加载 sp 地址到 %rax
    1135:	0f b6 00             	movzbl (%rax),%eax  //读取 sp 指向的内容并0填充扩展到 %eax
    1138:	0f be d0             	movsbl %al,%edx // 读取低8位，以有符号的方式扩展后放到 %edx
    113b:	48 8b 45 f8          	mov    -0x8(%rbp),%rax // 加载 dp 地址到 %rax
    113f:	89 10                	mov    %edx,(%rax) // 将结果写到 dp 所代表的地址
